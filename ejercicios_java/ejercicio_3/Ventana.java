...
public class Ventana extends JFrame {
    public Ventana(){
     setLayout(null);
        ...
        // setBounds((int)(width*0.3) ,(int) (height/2.8), (int)(height/2) - ((int)((width*0.3)/2)) , (int)(height/2) );
        ...
        JFormattedTextField form1 = new JFormattedTextField(new Integer(0) );
        JpanelTexFormWidth texform1 = new JpanelTexFormWidth("#1",width,height,20,form1);
        panePrincipal.add(texform1);

        
        JFormattedTextField form2 = new JFormattedTextField(new Integer(0));
        JpanelTexFormWidth texform2 = new JpanelTexFormWidth("#2",width,height,45+(int)(width*0.07-20 ) , form2);
        panePrincipal.add(texform2);

        
        JFormattedTextField form3 = new JFormattedTextField(new Integer(0));
        JpanelTexFormWidth texform3 = new JpanelTexFormWidth("#3",width,height,65+(int)((width*0.07-20)*2 ),form3);
...
class JpanelTexFormWidth extends JPanel {
    public JpanelTexFormWidth(String title,int width, int height,int bx, JTextField form ) {
        ...
        // form.setSize((int)(width*0.1-20 ),20);
        form.setText("");
    ...
    public JpanelButton(int height,int width,JTextField n1,JTextField n2,JTextField n3   ){
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evento) {
                ...
                JOptionPane.showMessageDialog(null ,message , "Area en las siguientes medidas", 1);
