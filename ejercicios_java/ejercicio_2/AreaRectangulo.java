...
public class AreaRectangulo {
    ...
    Methods.etiquetar(altura, ventana, "Ingrese la altura del rectangulo en metros");
    Methods.mostrarCampo(campoAltura, ventana);
    Methods.etiquetar(base, ventana, "Ingrese la base del rectangulo en metros");
    Methods.mostrarCampo(campoBase, ventana);
    Methods.sizedBox(ventana, vacio);
    Methods.mostraBotonRadius(ventana, button);
    ...
    button.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent evento) {
            try {
                Functions.calcular(campoAltura,campoBase,resultado,resultadoCm,resultadoMm,resultadoMtrs, ventana );
            } catch (Exception e) {
