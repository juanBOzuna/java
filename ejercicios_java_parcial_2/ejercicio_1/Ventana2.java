...
public class Ventana2 extends JFrame {
    ...
    JPanel panel(int x, int y, int widths, int heights, int i) {
        ...
        // "ejercicios_java_parcial_2\ejercicio_1\Ventana2.java"
        String ruta = "ejercicios_java_parcial_2/ejercicio_1/assets/cara-" + Integer.toString(i) + "-removebg-preview.png";
