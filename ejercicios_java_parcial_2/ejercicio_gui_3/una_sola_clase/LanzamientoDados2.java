package ejercicios_java_parcial_2.ejercicio_gui_3.una_sola_clase;
...
class Launching extends JPanel {
    ...
    public Launching(int x, int y, int w, int h, int index, int random1, int random2, Boolean status) {
        ...
        Image img = new ImageIcon(
                !status ? "ejercicios_java_parcial_2/ejercicio_3/assets/cara-" + random1 + "-removebg-preview.png"
                        : "ejercicios_java_parcial_2/ejercicio_3/assets/1MataTodo.png").getImage();
        ...
        Image imge2 = new ImageIcon(
                !status ? "ejercicios_java_parcial_2/ejercicio_3/assets/cara-" + random2 + "-removebg-preview.png"
                        : "ejercicios_java_parcial_2/ejercicio_3/assets/1MataTodo.png").getImage();
