...
class Launching extends JPanel {
    ...
    public Launching(int x, int y, int w, int h, int index, int random1, int random2) {
        ...
        Image img = new ImageIcon(
                "ejercicios_java_parcial_2/ejercicio_gui_2/assets/cara-" + random1 + "-removebg-preview.png").getImage();
        ...
        Image imge2 = new ImageIcon(
                "ejercicios_java_parcial_2/ejercicio_gui_2/assets/cara-" + random2 + "-removebg-preview.png").getImage();
